<div>
    @if ($show && $review)
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6"
            ...
            {{-- Modal Box Container --}}
            <div class="relative flex flex-col w-full max-w-3xl max-h-[85vh] rounded-xl bg-card shadow-2xl border border-border overflow-hidden z-10"
                 x-transition:enter="transition ease-out duration-300"
                 x-transition:enter-start="opacity-0 scale-95 translate-y-4"
                 x-transition:enter-end="opacity-100 scale-100 translate-y-0">

                {{-- Header (Fixed Top) --}}
                <div class="flex items-start justify-between border-b border-border p-5 sm:p-6 pb-4 bg-card shrink-0">
                    <div>
                ...
                {{-- Footer (Fixed Bottom) --}}
                <div class="flex items-center justify-end gap-3 border-t border-border p-4 sm:p-5 bg-card shrink-0">
                    {{-- Toggle Visibility --}}
                    @if ($review->is_visible)
