<div>
    @if ($show && $order)
        <div class="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto p-4 pt-8"
            ...
            <div class="relative w-full max-w-4xl rounded-2xl bg-white p-6 shadow-2xl border border-gray-200 text-gray-900 my-8"
                ...
                {{-- Timeline --}}
                <div class="mt-6 rounded-xl border border-gray-200 bg-gray-50 p-4 shadow-xs">
