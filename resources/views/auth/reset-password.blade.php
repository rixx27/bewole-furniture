<x-layouts::auth.premium :title="__('Reset Password')">
    <div class="flex flex-col gap-6">

        {{-- Header --}}
        <div class="flex w-full flex-col text-center animate-fade-in">
            <h1 class="text-[1.75rem] font-semibold tracking-tight text-[#2D2D2D]">{{ __('Reset Password') }}</h1>
            <p class="mt-1.5 text-sm text-[#2D2D2D]/55">{{ __('Masukkan alamat email dan kata sandi baru Anda.') }}</p>
        </div>
