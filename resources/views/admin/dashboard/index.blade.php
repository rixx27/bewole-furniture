                    ...
                    <tbody class="divide-y divide-border/50">
                        @forelse ($stats['recentOrders'] as $order)
                            <tr class="transition-colors hover:bg-bg-secondary/30">
                                <td class="px-6 py-3 text-sm font-mono font-medium text-text-primary dark:text-black">{{ $order->order_code }}</td>
...
{{-- Buat Kategori --}}
            <a href="{{ route('admin.categories.index') }}" class="group flex items-center gap-4 rounded-xl border border-border bg-card p-5 shadow-sm transition-all duration-200 hover:border-primary/30 hover:shadow-md">
