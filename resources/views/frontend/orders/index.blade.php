...
<div class="min-h-screen bg-wood-bg pt-24 sm:pt-28">
    <div class="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        {{-- Header --}}
        <div class="mb-8">
            <nav class="mb-4 flex items-center gap-2 text-xs text-wood-muted">
                <a href="{{ route('home') }}" class="hover:text-wood-primary">Home</a>
                <span>/</span>
                <span class="font-semibold text-wood-text">Pesanan Saya</span>
            </nav>
            <h1 class="text-3xl font-bold tracking-tight text-wood-text font-serif">Pesanan Saya</h1>
            <p class="mt-1 text-sm text-wood-muted">Riwayat semua pesanan furniture yang telah Anda buat.</p>
        </div>
