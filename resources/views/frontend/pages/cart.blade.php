...
@section('content')
    <section class="relative overflow-hidden bg-wood-primary-dark pt-36 pb-20 sm:pt-40 lg:pt-44 lg:pb-24">
        ...
        <div class="relative mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <h1 class="font-serif text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">Keranjang Belanja</h1>
            <p class="mt-4 max-w-2xl text-sm leading-relaxed text-white/85 sm:text-base">Tinjau produk furniture pilihan Anda sebelum melanjutkan ke pembayaran.</p>
        </div>
    </section>
